...
from SMILESX import model, utils, model

def geom_search(data_token, data_extra, subsample_size, hyper_bounds, hyper_opt, dense_depth, vocab_size, max_length, geom_file, strategy):
...
def geom_prescore(data, extra, geom, extra_dim, dense_depth, vocab_size, max_length, strategy):
...
def geom_score(data, extra, geom, extra_dim, dense_depth, weight_range, vocab_size, max_length, strategy):
    """Find the optimal weights for the trainless geometry search
